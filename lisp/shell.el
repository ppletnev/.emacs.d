...
;; Make HOME a default directory on startup
(cd "~")
...
(defmacro esh-section (NAME ICON ICON-FAMILY FORM &rest PROPS)
  "Build eshell section NAME with ICON prepended to evaled FORM with PROPS."
  `(setq ,NAME (lambda () (concat (propertize ,ICON 'face '(list ,@PROPS :family ,ICON-FAMILY))
                               (propertize (concat " " ,FORM) 'face '(list ,@PROPS))))))
